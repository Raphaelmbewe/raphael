...
class SmallProjectsPage extends StatefulWidget {
  @override
  _SmallProjectsPageState createState() => _SmallProjectsPageState();
}
            ...
            child: Column(children: <Widget> [
              SizedBox(height:height * 0.15),
               ...
               FadeAnimation(2.5, Container(
                  ...
                  child: FlatButton( onPressed: ()=> Navigator.pushReplacement(context, MaterialPageRoute(builder:(context) => PhoneScreen())),
